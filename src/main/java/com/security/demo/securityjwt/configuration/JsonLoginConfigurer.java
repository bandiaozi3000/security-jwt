...
import com.security.demo.securityjwt.filter.MyUsernamePasswordAuthenticationFilter;
...
//		authFilter.setAuthenticationSuccessHandler(new JsonLoginSuccessHandler(new JwtUserService()));
